...
class AddBalance extends StatefulWidget {
  ...
  final Function(String) numberBlance;
  const AddBalance(this.updateBalance, this.numberBlance, {super.key});
